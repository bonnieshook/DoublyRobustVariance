...
source('00_Functions.R')
  ...
  #truncate values at the extremes
  dat$Y_scaled<-ifelse(dat$Y_scaled<0.0005,0.0005,ifelse(dat$Y_scaled>0.9995,0.9995,dat$Y_scaled))
  ...
  colnames(DR.all)<-c('ATE', 'ESseATE','IFseATE','type')
